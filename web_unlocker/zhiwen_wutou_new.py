...
# 基础配置
BASE_URL = "http://queue.scraping.thordata.com/v1/webunlock"
HEADERS = {
    "Accept": "*/*",
...
# 使用固定代理
FIXED_PROXY = "acen_http-region-us:0bd66e5101407836202493a81c62ac31@43.153.12.213:6000"
...
#    proxy_display = selected_proxy.split('@')[-1]
    selected_proxy = FIXED_PROXY  # 使用固定代理
    proxy_display = selected_proxy.split('@')[-1]
    elapsed_time = 0.0
